...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/user/{id}/block', [ProfileController::class, 'blockUser'])->name('user.block');
    Route::post('/user/{id}/unblock', [ProfileController::class, 'unblockUser'])->name('user.unblock');
});
